...
ENV APACHE_SERVERNAME docker.nicollation.com
ENV APACHE_SERVERALIAS docker.nicollation.com
...
RUN mkdir /var/www/application && cd /var/www/application && git clone https://github.com/Nicollation/docker-apache-app.git .
